    ...
    return {
        ...
        renderBoxes: function renderBoxes() {
            ...
            Collection.list.forEach(function (org, index) {
                ...
                var ariaLabel = state === KEEP_CLOSED_CLASS ? 'This organization will be revealed on ' + org.date_string + '.' : 'Click this button to reveal the featured organization for ' + org.date_string + '.';
